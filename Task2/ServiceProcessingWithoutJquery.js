...
function grater_than_clear() {
    ...
    xhr.open('POST', 'StudentListWebService.asmx/GetStudentsGraterThan');
...
function lower_than_clear() {
    ...
    xhr.open('POST', 'StudentListWebService.asmx/GetStudentsLowerThan');
...
function in_range_clear() {
    ...
    xhr.open('POST', 'StudentListWebService.asmx/GetStudentsInRange');
